...
def read_records(path, sep=","):
    ...
    return {
        ...
        "platform_x": read_record(os.path.join(path, "platform_position_x.csv"), sep),
        "platform_y": read_record(os.path.join(path, "platform_position_y.csv"), sep),
        "platform_z": read_record(os.path.join(path, "platform_position_z.csv"), sep),
        # Platform attitude records
        "platform_roll": read_record(os.path.join(path, "platform_roll.csv"), sep),
        "platform_pitch": read_record(os.path.join(path, "platform_pitch.csv"), sep),
        "platform_yaw": read_record(os.path.join(path, "platform_yaw.csv"), sep),
        # Platform mount position records
        "platform_mount_x": read_record(
            os.path.join(path, "platform_mount_x.csv"), sep
        ),
        "platform_mount_y": read_record(
            os.path.join(path, "platform_mount_y.csv"), sep
        ),
        "platform_mount_z": read_record(
            os.path.join(path, "platform_mount_z.csv"), sep
        ),
        # Platform mount attitude records
        "platform_mount_roll": read_record(
            os.path.join(path, "platform_mount_roll.csv"), sep
        ),
        "platform_mount_pitch": read_record(
            os.path.join(path, "platform_mount_pitch.csv"), sep
        ),
        "platform_mount_yaw": read_record(
            os.path.join(path, "platform_mount_yaw.csv"), sep
        ),
        # Scanner position records
        "scanner_x": read_record(os.path.join(path, "scanner_position_x.csv"), sep),
        "scanner_y": read_record(os.path.join(path, "scanner_position_y.csv"), sep),
        "scanner_z": read_record(os.path.join(path, "scanner_position_z.csv"), sep),
        # Scanner attitude records
        "scanner_roll": read_record(os.path.join(path, "scanner_roll.csv"), sep),
        "scanner_pitch": read_record(os.path.join(path, "scanner_pitch.csv"), sep),
        "scanner_yaw": read_record(os.path.join(path, "scanner_yaw.csv"), sep),
        # Scanner head attitude records
        "scanner_head_roll": read_record(
            os.path.join(path, "scanner_head_roll.csv"), sep
        ),
        "scanner_head_pitch": read_record(
            os.path.join(path, "scanner_head_pitch.csv"), sep
        ),
        "scanner_head_yaw": read_record(
            os.path.join(path, "scanner_head_yaw.csv"), sep
        ),
        # Scanner head angle records
        "scanner_head_exact_angle": read_record(
            os.path.join(path, "scanner_head_exact_angle.csv"), sep
        ),
        "scanner_head_angle": read_record(
            os.path.join(path, "scanner_head_angle.csv"), sep
        ),
        # Deflector angle records
        "deflector_exact_angle": read_record(
            os.path.join(path, "deflector_exact_angle.csv"), sep
        ),
        "deflector_angle": read_record(os.path.join(path, "deflector_angle.csv"), sep),
        # Beam deflector attitude records
        "deflector_emitting_roll": read_record(
            os.path.join(path, "deflector_emitting_roll.csv"), sep
        ),
        "deflector_emitting_pitch": read_record(
            os.path.join(path, "deflector_emitting_pitch.csv"), sep
        ),
        "deflector_emitting_yaw": read_record(
            os.path.join(path, "deflector_emitting_yaw.csv"), sep
        ),
        # Beam origin records
        "beam_origin_x": read_record(os.path.join(path, "beam_origin_x.csv"), sep),
        "beam_origin_y": read_record(os.path.join(path, "beam_origin_y.csv"), sep),
        "beam_origin_z": read_record(os.path.join(path, "beam_origin_z.csv"), sep),
        # Beam attitude records
        "beam_roll": read_record(os.path.join(path, "beam_roll.csv"), sep),
        "beam_pitch": read_record(os.path.join(path, "beam_pitch.csv"), sep),
        "beam_yaw": read_record(os.path.join(path, "beam_yaw.csv"), sep),
        # Stochastic records
        "measurement_error_sequential": read_record(
            os.path.join(path, "measurement_error_sequential.csv"), sep
        ),
        "measurement_error_parallel": read_record(
            os.path.join(path, "measurement_error_parallel.csv"), sep
        ),
    }
...
def do_platform_position_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("platform_x", arec, "a")
        or not validate_record("platform_y", arec, "a")
        or not validate_record("platform_z", arec, "a")
        or not validate_record("platform_x", brec, "b")
        or not validate_record("platform_y", brec, "b")
        or not validate_record("platform_z", brec, "b")
    ):
    ...
    fig.savefig(os.path.join(outdir, "platform_position.png"))
    fig.clear()
    plt.close(fig)
...
def do_platform_mount_position_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("platform_mount_x", arec, "a")
        or not validate_record("platform_mount_y", arec, "a")
        or not validate_record("platform_mount_z", arec, "a")
        or not validate_record("platform_mount_x", brec, "b")
        or not validate_record("platform_mount_y", brec, "b")
        or not validate_record("platform_mount_z", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "platform_mount_position.png"))
    fig.clear()
    plt.close(fig)
...
def do_scanner_position_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("scanner_x", arec, "a")
        or not validate_record("scanner_y", arec, "a")
        or not validate_record("scanner_z", arec, "a")
        or not validate_record("scanner_x", brec, "b")
        or not validate_record("scanner_y", brec, "b")
        or not validate_record("scanner_z", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "scanner_position.png"))
    fig.clear()
    plt.close(fig)
...
def do_beam_origin_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("beam_origin_x", arec, "a")
        or not validate_record("beam_origin_y", arec, "a")
        or not validate_record("beam_origin_z", arec, "a")
        or not validate_record("beam_origin_x", brec, "b")
        or not validate_record("beam_origin_y", brec, "b")
        or not validate_record("beam_origin_z", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "beam_origin.png"))
    fig.clear()
    plt.close(fig)
...
def do_platform_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("platform_roll", arec, "a")
        or not validate_record("platform_pitch", arec, "a")
        or not validate_record("platform_yaw", arec, "a")
        or not validate_record("platform_roll", brec, "b")
        or not validate_record("platform_pitch", brec, "b")
        or not validate_record("platform_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "platform_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_platform_mount_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("platform_mount_roll", arec, "a")
        or not validate_record("platform_mount_pitch", arec, "a")
        or not validate_record("platform_mount_yaw", arec, "a")
        or not validate_record("platform_mount_roll", brec, "b")
        or not validate_record("platform_mount_pitch", brec, "b")
        or not validate_record("platform_mount_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "platform_mount_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_scanner_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("scanner_roll", arec, "a")
        or not validate_record("scanner_pitch", arec, "a")
        or not validate_record("scanner_yaw", arec, "a")
        or not validate_record("scanner_roll", brec, "b")
        or not validate_record("scanner_pitch", brec, "b")
        or not validate_record("scanner_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "scanner_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_scanner_head_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("scanner_head_roll", arec, "a")
        or not validate_record("scanner_head_pitch", arec, "a")
        or not validate_record("scanner_head_yaw", arec, "a")
        or not validate_record("scanner_head_roll", brec, "b")
        or not validate_record("scanner_head_pitch", brec, "b")
        or not validate_record("scanner_head_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "scanner_head_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_exact_and_error_subplot(
    ...
    if title is not None:
        ax.set_title(title, fontsize=20)
    ax.plot(steps, exact, lw=2, color="black", label="No error", zorder=4)
    ax.plot(steps, witherr, lw=4, color="tab:red", label="With error", zorder=3)
    ax.set_xlabel("Simulation steps", fontsize=16)
    if ylabel is not None:
        ax.set_ylabel(ylabel, fontsize=16)
...
def do_head_and_deflector_angle_plots(arec, brec, outdir):
    if (
        not validate_record("scanner_head_exact_angle", arec, "a")
        or not validate_record("scanner_head_angle", arec, "a")
        or not validate_record("deflector_exact_angle", arec, "a")
        or not validate_record("deflector_angle", arec, "a")
        or not validate_record("scanner_head_exact_angle", brec, "b")
        or not validate_record("scanner_head_angle", brec, "b")
        or not validate_record("deflector_exact_angle", brec, "b")
        or not validate_record("deflector_angle", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "head_and_deflector_angles.png"))
    fig.clear()
    plt.close(fig)
...
def do_beam_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("beam_roll", arec, "a")
        or not validate_record("beam_pitch", arec, "a")
        or not validate_record("beam_yaw", arec, "a")
        or not validate_record("beam_roll", brec, "b")
        or not validate_record("beam_pitch", brec, "b")
        or not validate_record("beam_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "beam_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_deflector_emitting_attitude_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("deflector_emitting_roll", arec, "a")
        or not validate_record("deflector_emitting_pitch", arec, "a")
        or not validate_record("deflector_emitting_yaw", arec, "a")
        or not validate_record("deflector_emitting_roll", brec, "b")
        or not validate_record("deflector_emitting_pitch", brec, "b")
        or not validate_record("deflector_emitting_yaw", brec, "b")
    ):
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "deflector_emitting_attitude.png"))
    fig.clear()
    plt.close(fig)
...
def do_measurement_error_plots(arec, brec, outdir):
    ...
    if (
        not validate_record("measurement_error_sequential", arec, "a")
        or not validate_record("measurement_error_parallel", arec, "a")
        or not validate_record("measurement_error_sequential", brec, "b")
        or not validate_record("measurement_error_parallel", brec, "b")
    ):
    ...
    do_error_distribution_histogram(
        fig,
        ax,
        arec["measurement_error_sequential"],
        label="$a$",
    ...
    do_error_distribution_histogram(
        fig,
        ax,
        brec["measurement_error_sequential"],
        label="$b$",
    ...
    do_error_distribution_histogram(
        fig,
        ax,
        arec["measurement_error_parallel"],
        label="$a$",
    ...
    do_error_distribution_histogram(
        fig,
        ax,
        brec["measurement_error_parallel"],
        label="$b$",
    ...
    fig.tight_layout()
    # Save figure to file and remove it from memory
    fig.savefig(os.path.join(outdir, "measurement_error.png"))
    fig.clear()
    plt.close(fig)
