...
public:
  ...
  void craft()
  {
    ...
    if (n > 31)
      n = 31;
    memcpy(lwHeader.generating_software, ssStr.c_str(), sizeof(char) * n);
  ...
  void addExtraAttributes()
  {
    ...
    try {
      ...
      LASattribute ampAttr(ampType, "heliosAmplitude", "Helios++ Amplitude");
                                        ...
                                        bool const compress)
  {
    ...
    if (compress)
      ...
      lwOpener.set_format(LAS_TOOLS_FORMAT_LAS);
