...
protected:
  ...
  std::map<std::string, size_t> identifiers =
    std::map<std::string, size_t>({ { "PadBVTotal", 0 },
                                    { "angleMean", 1 },
                                    { "bsEntering", 2 },
                                    { "bsIntercepted", 3 },
                                    { "bsPotential", 4 },
...
public:
   ...
   */
  DetailedVoxel(glm::dvec3 center,
                double voxelSize,
                std::vector<int> intValues,
                std::vector<double> doubleValues)
   ...
   */
  inline double& operator[](size_t index) { return doubleValues[index]; }
  /**
   ...
   */
  inline int getNbEchos() { return intValues[0]; }
  /**
   ...
   */
  inline int getNbSampling() { return intValues[1]; }
  /**
   ...
   */
  inline size_t getNumberOfIntValues() const { return intValues.size(); }
  /**
   ...
   */
  inline size_t getNumberOfDoubleValues() const { return doubleValues.size(); }
  /**
   ...
   */
  inline int getIntValue(size_t index) const { return intValues[index]; }
  /**
   ...
   */
  bool canComputeSigmaWithLadLut() override { return part->ladlut != nullptr; }
  /**
