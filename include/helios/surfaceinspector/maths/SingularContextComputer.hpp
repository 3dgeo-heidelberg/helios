...
#include <helios/surfaceinspector/maths/SingularContextDescriptors.hpp>
...
public:
   ...
   */
  SingularContextComputer() { init(true, true, 1, 1, 1, 1); }
  /**
...
#include <helios/surfaceinspector/maths/SingularContextComputer.tpp>
