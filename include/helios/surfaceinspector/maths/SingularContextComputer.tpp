#include <helios/surfaceinspector/maths/Histogram.hpp>
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::init(bool normalize,
                                                          bool center,
                                                          std::size_t aWorst,
                                                          std::size_t aBest,
                                                          std::size_t bWorst,
...
// ************************ //
template<typename T>
SurfaceInspector::maths::SingularContextDescriptors<T>
SurfaceInspector::maths::SingularContextComputer<T>::describe(
  arma::Mat<T>& M) const
{
  // Preprocess matrix
  if (normalizeFlag)
  ...
  if (absoluteComponents)
    vWorst = arma::abs(V.col(r - 1));
  if (aWorst > 0) {
    scd.worstVectorMinIndices = alpha(vWorst, aWorst);
    scd.worstVectorMinComponents =
      extractComponents(vWorst, scd.worstVectorMinIndices);
  }
  if (bWorst > 0) {
    scd.worstVectorMaxIndices = beta(vWorst, bWorst);
    scd.worstVectorMaxComponents =
      extractComponents(vWorst, scd.worstVectorMaxIndices);
  }
  arma::vec vBest = V.col(0);
  if (absoluteComponents)
    vBest = arma::abs(V.col(0));
  if (aBest > 0) {
    scd.bestVectorMinIndices = alpha(vBest, aBest);
    scd.bestVectorMinComponents =
      extractComponents(vBest, scd.bestVectorMinIndices);
  }
  if (bBest > 0) {
    scd.bestVectorMaxIndices = beta(vBest, bBest);
    scd.bestVectorMaxComponents =
      extractComponents(vBest, scd.bestVectorMaxIndices);
  }
...
template<typename T>
std::vector<size_t>
SurfaceInspector::maths::SingularContextComputer<T>::alpha(
  arma::vec const& v,
  std::size_t const a) const
{
...
template<typename T>
std::vector<size_t>
SurfaceInspector::maths::SingularContextComputer<T>::beta(
  arma::vec const& v,
  std::size_t const b) const
{
...
template<typename T>
std::vector<T>
SurfaceInspector::maths::SingularContextComputer<T>::extractComponents(
  arma::vec const& v,
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::configureNorm(
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeDefault(
  arma::Mat<T>& M) const
{
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeRGB(
  arma::Mat<T>& M) const
{
  arma::vec col;
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeHSO(
  arma::Mat<T>& M) const
{
  arma::colvec col;
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeHLI(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Horizontality
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeLP(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Linearity
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeGdCd(
  arma::Mat<T>& M) const
{
  arma::colvec col;
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeGdCdI(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Ground distance
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeHV(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize horizontality
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeSO(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Sum
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeLC(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Linearity
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeVC(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Verticality
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizePC(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Planarity
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeVR(
  arma::Mat<T>& M) const
{
  arma::colvec col;
  // Normalize Verticality
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::normalizeCone(
  arma::Mat<T>& M) const
{
  // Normalize X
...
SurfaceInspector::maths::SingularContextComputer<
  T>::normalizeHyperbolicParaboloid(arma::Mat<T>& M) const
{
  // Normalize X
  M.col(0) = arma::pow(M.col(0) - arma::mean(M.col(0)), 2);
...
template<typename T>
void
SurfaceInspector::maths::SingularContextComputer<T>::centerDefault(
  arma::Mat<T>& M) const
{
  // Computer centroid
  std::size_t n = M.n_cols;
