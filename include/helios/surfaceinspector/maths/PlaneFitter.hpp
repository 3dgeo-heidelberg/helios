...
#include <helios/surfaceinspector/maths/DetailedPlane.hpp>
...
protected:
   ...
   */
  template<typename T>
  static void extractCommonPlaneComponents(arma::mat const& A,
                                           arma::vec const& v,
                                           T& sum,
                                           Plane<T>& p);
...
#include <helios/surfaceinspector/maths/PlaneFitter.tpp>
