#include <helios/maths/model/EnergyModel.h> // Include your EnergyModel header
#include <helios/scanner/ScanningDevice.h> // Include your ScanningDevice header
#include <memory>
...
public:
  ...
  EnergyModelWrap(ScanningDevice const& sd)
    : EnergyModel(sd)
  {
  }
