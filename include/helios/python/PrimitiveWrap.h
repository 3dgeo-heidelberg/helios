...
public:
  ...
  {
    PYBIND11_OVERRIDE_PURE(Primitive*, // Return type
  ...
  {
    PYBIND11_OVERRIDE_PURE(AABB*,     // Return type
                           Primitive, // Parent class
  ...
  {
    PYBIND11_OVERRIDE_PURE(glm::dvec3,  // Return type
                           Primitive,   // Parent class
  ...
  double getIncidenceAngle_rad(const glm::dvec3& p,
                               const glm::dvec3& d,
  ...
  {
    PYBIND11_OVERRIDE_PURE(std::vector<double>, // Return type
                           Primitive,           // Parent class
  ...
  double getRayIntersectionDistance(const glm::dvec3& p,
                                    const glm::dvec3& d) override
  {
  ...
  {
    PYBIND11_OVERRIDE_PURE(Vertex*,    // Return type
                           Primitive,  // Parent class
