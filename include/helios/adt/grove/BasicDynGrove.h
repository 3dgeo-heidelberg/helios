...
#include <helios/adt/grove/DynGrove.h>
...
template<typename Tree, typename Subject>
class BasicDynGrove
  : public BasicStaticGrove<Tree>
  , public DynGrove<Subject>
{
...
public:
   ...
   */
  virtual void addSubject(BasicDynGroveSubject<Tree, Subject>* subject,
   ...
   */
  virtual std::vector<BasicDynGroveSubject<Tree, Subject>*> const& getSubjects()
    const
  {
    return subjects;
  }
...
#include <helios/adt/grove/BasicDynGrove.tpp>
#endif
