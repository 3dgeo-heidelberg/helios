...
#include <helios/adt/exprtree/IExprTreeNodeStringFactory.h>
...
template<typename NumericType,
         typename ExprTreeType = UnivarExprTreeNode<NumericType>>
...
public:
  ...
  IExprTreeNode<NumericType, NumericType>* make(
    std::string const& expr) override;
   ...
   */
  inline unsigned int calcOpPriority(Symbol const& symbol)
  {
   ...
   * @return Built node
   */
  virtual ExprTreeType* newExprTree(ExprTreeType* left = nullptr,
   ...
   */
  virtual void prepareNextSubExpression(Symbol const& symbol,
                                        std::string& subexpr);
  /**
   ...
   */
  std::string stringFromNumber(NumericType const x,
  ...
  {
    return opStr == "+" || opStr == "-" || opStr == "*" || opStr == "/" ||
           opStr == "^" || opStr == "(" || opStr == ")" || opStr == "atan2";
  }
  /**
  ...
  {
    return funStr == "exp" || funStr == "ln" || funStr == "sqrt" ||
           funStr == "abs" || funStr == "cos" || funStr == "sin" ||
           funStr == "tan" || funStr == "acos" || funStr == "asin" ||
           funStr == "atan" || funStr == "cosh" || funStr == "sinh" ||
           funStr == "tanh";
  }
};

#include <helios/adt/exprtree/UnivarExprTreeStringFactory.tpp>
