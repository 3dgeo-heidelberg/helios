...
#include <helios/maths/fluxionum/DiffMinimizer.h>
#include <helios/maths/fluxionum/IterativeMethodHandler.h>
...
#include <helios/maths/fluxionum/UnivariateNewtonRaphsonMinimizer.tpp>
