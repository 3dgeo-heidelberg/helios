...
## Table of contents
1. [Download pre-built](#download-pre-built)
1. [Install](#install)
...
***TODO** decide how to distribute dependencies. We can request user to download and
handle them or we can provide them already built.* 
