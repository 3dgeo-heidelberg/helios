...
BOOST_PYTHON_MODULE(_pyhelios)
{
  ...
  class_<PyHeliosSimulation>("Simulation", init<>())
    ...
    .def(init<std::string,
              ...
              int,
              int>())
    .def("loadSurvey", &PyHeliosSimulation::loadSurvey)
    .def("copy",
    ...
    .def("getScene",
         ...
         return_value_policy<manage_new_object>())
    .def("getNumLegs", &PyHeliosSimulation::getNumLegs)
    .def("getLeg", &PyHeliosSimulation::getLeg, return_internal_reference<>())
    .def("removeLeg", &PyHeliosSimulation::removeLeg)
    .def("newLeg", &PyHeliosSimulation::newLeg, return_internal_reference<>())
    .def("newLegFromTemplate",
         &PyHeliosSimulation::newLegFromTemplate,
         return_internal_reference<>())
    .def("newScanningStrip",
         &PyHeliosSimulation::newScanningStrip,
         return_value_policy<manage_new_object>())
    .def("assocLegWithScanningStrip",
         &PyHeliosSimulation::assocLegWithScanningStrip)
    .add_property("simulationFrequency",
                  &PyHeliosSimulation::getSimFrequency,
                  &PyHeliosSimulation::setSimFrequency)
    .add_property("dynSceneStep",
                  &PyHeliosSimulation::getDynSceneStep,
                  &PyHeliosSimulation::setDynSceneStep)
    .add_property("callbackFrequency",
                  &PyHeliosSimulation::getCallbackFrequency,
                  &PyHeliosSimulation::setCallbackFrequency)
    .add_property("finalOutput",
                  &PyHeliosSimulation::finalOutput,
                  &PyHeliosSimulation::finalOutput)
    .add_property("legacyEnergyModel",
                  &PyHeliosSimulation::legacyEnergyModel,
                  &PyHeliosSimulation::legacyEnergyModel)
    .add_property("exportToFile",
  ...
  class_<Survey, boost::noncopyable>("Survey", no_init)
    ...
    .add_property(
      "simSpeedFactor", &Survey::simSpeedFactor, &Survey::simSpeedFactor);

  // Register ScannerSettings
  class_<ScannerSettings>("ScannerSettings", no_init)
    .add_property("active", &ScannerSettings::active, &ScannerSettings::active)
    .add_property("headRotatePerSec",
                  &ScannerSettings::headRotatePerSec_rad,
                  &ScannerSettings::headRotatePerSec_rad)
    .add_property("headRotateStart",
                  &ScannerSettings::headRotateStart_rad,
                  &ScannerSettings::headRotateStart_rad)
    .add_property("headRotateStop",
                  &ScannerSettings::headRotateStop_rad,
                  &ScannerSettings::headRotateStop_rad)
    .add_property("pulseFreq",
                  &ScannerSettings::pulseFreq_Hz,
                  &ScannerSettings::pulseFreq_Hz)
    .add_property("scanAngle",
                  &ScannerSettings::scanAngle_rad,
                  &ScannerSettings::scanAngle_rad)
    .add_property("verticalAngleMin",
                  &ScannerSettings::verticalAngleMin_rad,
                  &ScannerSettings::verticalAngleMin_rad)
    .add_property("verticalAngleMax",
                  &ScannerSettings::verticalAngleMax_rad,
                  &ScannerSettings::verticalAngleMax_rad)
    .add_property(
      "scanFreq", &ScannerSettings::scanFreq_Hz, &ScannerSettings::scanFreq_Hz)
    .add_property("beamDivAngle",
                  &ScannerSettings::beamDivAngle,
                  &ScannerSettings::beamDivAngle)
    .add_property("trajectoryTimeInterval",
                  &ScannerSettings::trajectoryTimeInterval,
                  &ScannerSettings::trajectoryTimeInterval)
    .add_property("warmupPhase",
                  &ScannerSettings::warmupPhase_s,
                  &ScannerSettings::warmupPhase_s)
    ...
    .def("getTemplate",
         ...
         return_internal_reference<>())
    .def("toString", &ScannerSettings::toString);
  ...
  class_<PlatformSettings>("PlatformSettings", no_init)
    ...
    .add_property("stopAndTurn",
                  ...
                  &PlatformSettings::stopAndTurn)
    .add_property("movePerSec",
                  &PlatformSettings::movePerSec_m,
                  &PlatformSettings::movePerSec_m)
    .add_property("slowdownEnabled",
                  &PlatformSettings::slowdownEnabled,
                  &PlatformSettings::slowdownEnabled)
    .add_property("yawAtDepartureSpecified",
                  &PlatformSettings::yawAtDepartureSpecified,
                  &PlatformSettings::yawAtDeparture)
    .add_property("yawAtDeparture",
                  &PlatformSettings::yawAtDeparture,
                  &PlatformSettings::yawAtDeparture)
    .add_property("smoothTurn",
                  &PlatformSettings::smoothTurn,
                  &PlatformSettings::smoothTurn)
    .def("hasTemplate", &PlatformSettings::hasTemplate)
    .def("getTemplate",
         &PlatformSettings::getTemplate,
         return_internal_reference<>())
    .def("toString", &PlatformSettings::toString);
  ...
  class_<Leg, boost::noncopyable>("Leg", no_init)
    ...
    .add_property(
      ...
      make_function(
        ...
        return_value_policy<manage_new_object>()),
      +[](Leg& leg, PyScanningStripWrapper* pssw) { leg.setStrip(pssw->ss); })
    .def("getScannerSettings",
         &Leg::getScannerSettings,
         return_internal_reference<>())
    .def("getPlatformSettings",
  ...
  class_<PyScannerWrapper, boost::noncopyable>("Scanner", no_init)
    ...
    .def("getReceiverDiameter",
         static_cast<double (PyScannerWrapper::*)(size_t const) const>(
           &PyScannerWrapper::getReceiverDiameter))
    .def("setReceiverDiameter",
         static_cast<void (PyScannerWrapper::*)(double const, size_t const)>(
           &PyScannerWrapper::setReceiverDiameter))
    .add_property( // Only access first device. Use get/set for n device
      "visibility",
    ...
    .def("getAtmosphericExtinction",
         static_cast<double (PyScannerWrapper::*)(size_t const) const>(
           &PyScannerWrapper::getAtmosphericExtinction))
    .def("setAtmosphericExtinction",
         static_cast<void (PyScannerWrapper::*)(double const, size_t const)>(
           &PyScannerWrapper::setAtmosphericExtinction))
    .add_property( // Only access first device. Use get/set for n device
      "beamWaistRadius",
    ...
    .def("getBeamWaistRadius",
         static_cast<double (PyScannerWrapper::*)(size_t const) const>(
           &PyScannerWrapper::getBeamWaistRadius))
    .def("setBeamWaistRadius",
         static_cast<void (PyScannerWrapper::*)(double const, size_t const)>(
           &PyScannerWrapper::setBeamWaistRadius))
    .add_property( // Only access first device. Use get/set for n device
      "maxNOR",
    ...
    .def("getRelativePosition",
         static_cast<PythonDVec3* (PyScannerWrapper::*)(size_t const)>(
           &PyScannerWrapper::getRelativePosition),
         return_value_policy<manage_new_object>())
    .def("getIntersectionHandlingNoiseSource",
    ...
    .def("getScannerHead",
         static_cast<ScannerHead& (PyScannerWrapper::*)(size_t const)>(
           &PyScannerWrapper::getScannerHead),
         return_internal_reference<>())
    .def("getBeamDeflector",
         static_cast<PyBeamDeflectorWrapper* (PyScannerWrapper::*)()>(
           &PyScannerWrapper::getPyBeamDeflector),
         return_value_policy<manage_new_object>())
    .def(
      "getBeamDeflector",
      static_cast<PyBeamDeflectorWrapper* (PyScannerWrapper::*)(size_t const)>(
        &PyScannerWrapper::getPyBeamDeflector),
      return_value_policy<manage_new_object>())
    .def("getDetector",
         static_cast<PyDetectorWrapper* (PyScannerWrapper::*)()>(
           &PyScannerWrapper::getPyDetectorWrapper),
         return_value_policy<manage_new_object>())
    .def("getDetector",
         static_cast<PyDetectorWrapper* (PyScannerWrapper::*)(size_t const)>(
           &PyScannerWrapper::getPyDetectorWrapper),
         return_value_policy<manage_new_object>())
    .def("calcRaysNumber",
    ...
    .def("calcAtmosphericAttenuation",
         static_cast<double (PyScannerWrapper::*)(size_t const) const>(
           &PyScannerWrapper::calcAtmosphericAttenuation))
    .add_property("fixedIncidenceAngle",
    ...
    .def(
      "setDeviceId",
      static_cast<void (PyScannerWrapper::*)(std::string const, size_t const)>(
        &PyScannerWrapper::setDeviceId))
    .add_property(
      "id", &PyScannerWrapper::getScannerId, &PyScannerWrapper::setScannerId)
    .def("getNumDevices", &PyScannerWrapper::getNumDevices);

  // Register FWFSettings
  class_<FWFSettings>("FWFSettings", no_init)
    .add_property(
      "binSize_ns", &FWFSettings::binSize_ns, &FWFSettings::binSize_ns)
    .add_property(
      "minEchoWidth", &FWFSettings::minEchoWidth, &FWFSettings::minEchoWidth)
    .add_property(
      "peakEnergy", &FWFSettings::peakEnergy, &FWFSettings::peakEnergy)
    .add_property("apertureDiameter",
                  &FWFSettings::apertureDiameter,
                  &FWFSettings::apertureDiameter)
    .add_property("scannerEfficiency",
                  &FWFSettings::scannerEfficiency,
                  &FWFSettings::scannerEfficiency)
    .add_property("atmosphericVisiblity",
                  &FWFSettings::atmosphericVisibility,
                  &FWFSettings::atmosphericVisibility)
    .add_property("scannerWaveLength",
                  &FWFSettings::scannerWaveLength,
                  &FWFSettings::scannerWaveLength)
    .add_property("beamDivergence",
                  &FWFSettings::beamDivergence_rad,
                  &FWFSettings::beamDivergence_rad)
    .add_property("pulseLength_ns",
                  &FWFSettings::pulseLength_ns,
                  &FWFSettings::pulseLength_ns)
    .add_property("beamSampleQuality",
                  &FWFSettings::beamSampleQuality,
                  &FWFSettings::beamSampleQuality)
    .add_property(
      "winSize_ns", &FWFSettings::winSize_ns, &FWFSettings::winSize_ns)
    .add_property("maxFullwaveRange_ns",
  ...
  class_<Rotation>("Rotation", no_init)
    ...
    .def(
      ...
      +[](Rotation& r) { return new PythonDVec3(r.getAxis()); },
  ...
  class_<ScannerHead>("ScannerHead", no_init)
    .add_property("rotatePerSecMax",
                  &ScannerHead::getRotatePerSecMax,
                  &ScannerHead::setRotatePerSecMax)
    .add_property("rotatePerSec",
                  &ScannerHead::getRotatePerSec_rad,
                  &ScannerHead::setRotatePerSec_rad)
    .add_property(
      "rotateStop", &ScannerHead::getRotateStop, &ScannerHead::setRotateStop)
    .add_property(
      "rotateStart", &ScannerHead::getRotateStart, &ScannerHead::setRotateStart)
    .add_property(
      "rotateRange", &ScannerHead::getRotateRange, &ScannerHead::setRotateRange)
    .add_property("currentRotateAngle",
                  &ScannerHead::getRotateCurrent,
                  &ScannerHead::setCurrentRotateAngle_rad)
    .def("getMountRelativeAttitude",
  ...
  class_<PyIntegerList>("IntegerList", no_init)
    .def("__getitem__", &PyIntegerList::get)
    .def("__setitem__", &PyIntegerList::set)
    .def("__len__", &PyIntegerList::length)
    .def("get", &PyIntegerList::get)
    .def("set", &PyIntegerList::set)
    .def("insert", &PyIntegerList::insert)
    .def("erase", &PyIntegerList::erase)
    .def("length", &PyIntegerList::length);

  // Register vector<double>
  class_<PyDoubleVector>("DoubleVector", no_init)
    .def("__getitem__", &PyDoubleVector::get)
    .def("__setitem__", &PyDoubleVector::set)
    .def("__len__", &PyDoubleVector::length)
    .def("get", &PyDoubleVector::get)
    .def("set", &PyDoubleVector::set)
    .def("insert", &PyDoubleVector::insert)
    .def("erase", &PyDoubleVector::erase)
    .def("length", &PyDoubleVector::length);

  // Register vector<string>
  class_<PyStringVector>("StringVector", no_init)
    .def("__getitem__", &PyStringVector::get)
    .def("__setitem__", &PyStringVector::set)
    .def("__len__", &PyStringVector::length)
    .def("get", &PyStringVector::get)
    .def("set", &PyStringVector::set)
    .def("insert", &PyStringVector::insert)
    .def("erase", &PyStringVector::erase)
    .def("length", &PyStringVector::length);

  // Register NoiseSource
  class_<PyNoiseSourceWrapper>("NoiseSource", no_init)
    .add_property("clipMin",
                  &PyNoiseSourceWrapper::getClipMin,
                  &PyNoiseSourceWrapper::setClipMin)
    .add_property("clipMax",
    ...
    .def("isFixedValueEnabled", &PyNoiseSourceWrapper::isFixedValueEnabled)
    .add_property("fixedLifespan",
  ...
  class_<PyPrimitiveWrapper>("Primitive", no_init)
    ...
    .def("getCentroid",
         ...
         return_value_policy<manage_new_object>())
    .def("getIncidenceAngle", &PyPrimitiveWrapper::getIncidenceAngle)
    .def("getRayIntersection",
         &PyPrimitiveWrapper::getRayIntersection,
         return_value_policy<manage_new_object>())
    .def("getRayIntersectionDistance",
         &PyPrimitiveWrapper::getRayIntersectionDistance)
    .def("getNumVertices", &PyPrimitiveWrapper::getNumVertices)
    .def("getVertex",
         &PyPrimitiveWrapper::getVertex,
         return_value_policy<manage_new_object>())
    .def("update", &PyPrimitiveWrapper::update)
    .def("isTriangle", &PyPrimitiveWrapper::isTriangle)
    .def("isAABB", &PyPrimitiveWrapper::isAABB)
    .def("isVoxel", &PyPrimitiveWrapper::isVoxel)
    .def("isDetailedVoxel", &PyPrimitiveWrapper::isDetailedVoxel);

  // Register Material
  class_<Material>("Material", no_init)
    .add_property("name", &Material::name, &Material::name)
    .add_property("isGround", &Material::isGround, &Material::isGround)
    .add_property(
      "useVertexColors", &Material::useVertexColors, &Material::useVertexColors)
    .add_property("matFilePath", &Material::matFilePath, &Material::matFilePath)
    .add_property("map_Kd", &Material::map_Kd, &Material::map_Kd)
    .add_property("reflectance", &Material::reflectance, &Material::reflectance)
    .add_property("specularity", &Material::specularity, &Material::specularity)
    .add_property("specularExponent",
                  &Material::specularExponent,
                  &Material::specularExponent)
    .add_property(
      "classification", &Material::classification, &Material::classification)
    .add_property("spectra", &Material::spectra, &Material::spectra)
    .add_property(
      "ka0",
  ...
  class_<PyScenePartWrapper>("ScenePart", no_init)
    .add_property("id", &PyScenePartWrapper::getId, &PyScenePartWrapper::setId)
    .def("getOrigin",
         &PyScenePartWrapper::getOrigin,
         return_value_policy<manage_new_object>())
    .def("setOrigin", &PyScenePartWrapper::setOrigin)
    .def("setRotation", &PyScenePartWrapper::setRotation)
    .def("getRotation",
         &PyScenePartWrapper::getRotation,
         return_internal_reference<>())
    .add_property(
      "scale", &PyScenePartWrapper::getScale, &PyScenePartWrapper::setScale)
    .def("isDynamicMovingObject", &PyScenePartWrapper::isDynamicMovingObject)
    .add_property("dynObjectStep",
                  &PyScenePartWrapper::getDynObjectStep,
                  &PyScenePartWrapper::setDynObjectStep)
    .add_property("observerStep",
                  &PyScenePartWrapper::getObserverStep,
                  &PyScenePartWrapper::setObserverStep)
    .def("getPrimitive",
         &PyScenePartWrapper::getPrimitive,
         return_value_policy<manage_new_object>())
    .def("getNumPrimitives", &PyScenePartWrapper::getNumPrimitives)
    .def("computeCentroid", &PyScenePartWrapper::computeCentroid)
    .def("computeBound", &PyScenePartWrapper::computeBound)
    .def("getCentroid",
    ...
    .def("getBound",
         ...
         return_value_policy<manage_new_object>())
    .def("translate", &PySceneWrapper::translate);
  ...
  class_<PySceneWrapper>("Scene", no_init)
    .def("newTriangle",
         ...
         return_value_policy<manage_new_object>())
    .def("newDetailedVoxel",
         &PySceneWrapper::newDetailedVoxel,
         return_value_policy<manage_new_object>())
    .def("getPrimitive",
         &PySceneWrapper::getPrimitive,
         return_value_policy<manage_new_object>())
    .def("getNumPrimitives", &PySceneWrapper::getNumPrimitives)
    .def("getAABB",
         &PySceneWrapper::getAABB,
         return_value_policy<manage_new_object>())
    .def("getGroundPointAt",
    ...
    .def("getShift",
         ...
         return_value_policy<manage_new_object>())
    .def("finalizeLoading", &PySceneWrapper::finalizeLoading)
    .def("writeObject", &PySceneWrapper::writeObject)
    .def("getNumSceneParts", &PySceneWrapper::getNumSceneParts)
    .def("getScenePart",
  ...
  class_<PyAABBWrapper>("AABB", no_init)
    ...
    .def("getMaxVertex",
         ...
         return_value_policy<manage_new_object>())
    .def("toString", &PyAABBWrapper::toString);
  ...
  // Register Triangle
  class_<PyTriangleWrapper, bases<PyPrimitiveWrapper>>("Triangle", no_init)
    .def("getFaceNormal",
         &PyTriangleWrapper::getFaceNormal,
         return_value_policy<manage_new_object>())
    .def("toString", &PyTriangleWrapper::toString);

  // Register DetailedVoxel
  class_<PyDetailedVoxelWrapper, bases<PyPrimitiveWrapper>>("DetailedVoxel",
                                                            no_init)
    .add_property("nbEchos",
                  &PyDetailedVoxelWrapper::getNbEchos,
                  &PyDetailedVoxelWrapper::setNbEchos)
    .add_property("nbSampling",
                  &PyDetailedVoxelWrapper::getNbSampling,
                  &PyDetailedVoxelWrapper::setNbSampling)
    .def("getNumberOfDoubleValues",
         &PyDetailedVoxelWrapper::getNumberOfDoubleValues)
    .def("getDoubleValue", &PyDetailedVoxelWrapper::getDoubleValue)
    .def("setDoubleValue", &PyDetailedVoxelWrapper::setDoubleValue)
    .add_property("maxPad",
  ...
  class_<PyMeasurementVectorWrapper>("MeasurementVector", no_init)
    .def("__getitem__",
         ...
         return_value_policy<manage_new_object>())
    .def("__len__", &PyMeasurementVectorWrapper::length)
    .def("get",
         &PyMeasurementVectorWrapper::get,
         return_value_policy<manage_new_object>())
    .def("erase", &PyMeasurementVectorWrapper::erase)
    .def("length", &PyMeasurementVectorWrapper::length);

  // Register Measurement
  class_<PyMeasurementWrapper>("Measurement", no_init)
    .add_property("hitObjectId",
                  &PyMeasurementWrapper::getHitObjectId,
                  &PyMeasurementWrapper::setHitObjectId)
    .def("getPosition",
         &PyMeasurementWrapper::getPosition,
         return_value_policy<manage_new_object>())
    .def("setPosition", &PyMeasurementWrapper::setPosition)
    .def("getBeamDirection",
         &PyMeasurementWrapper::getBeamDirection,
         return_value_policy<manage_new_object>())
    .def("setBeamDirection", &PyMeasurementWrapper::setBeamDirection)
    .def("getBeamOrigin",
         &PyMeasurementWrapper::getBeamOrigin,
         return_value_policy<manage_new_object>())
    .def("setBeamOrigin", &PyMeasurementWrapper::setBeamOrigin)
  ...
  class_<PyTrajectoryVectorWrapper>("TrajectoryVector", no_init)
    .def("__getitem__",
         ...
         return_value_policy<manage_new_object>())
    .def("__len__", &PyTrajectoryVectorWrapper::length)
    .def("get",
         &PyTrajectoryVectorWrapper::get,
         return_value_policy<manage_new_object>())
    .def("erase", &PyTrajectoryVectorWrapper::erase)
    .def("length", &PyTrajectoryVectorWrapper::length);
  ...
  class_<PyTrajectoryWrapper>("Trajectory", no_init)
    ...
    .def("setPosition",
         ...
         return_value_policy<manage_new_object>())
    .add_property(
      "roll", &PyTrajectoryWrapper::getRoll, &PyTrajectoryWrapper::setRoll)
    .add_property(
      "pitch", &PyTrajectoryWrapper::getPitch, &PyTrajectoryWrapper::setPitch)
    .add_property(
      "yaw", &PyTrajectoryWrapper::getYaw, &PyTrajectoryWrapper::setYaw);

  // Register PyHeliosOutputWrapper
  class_<PyHeliosOutputWrapper>("HeliosOutput", no_init)
    .add_property("measurements",
                  &PyHeliosOutputWrapper::measurements,
                  &PyHeliosOutputWrapper::measurements)
    .add_property("trajectories",
                  &PyHeliosOutputWrapper::trajectories,
                  &PyHeliosOutputWrapper::trajectories)
    .add_property("finished",
                  &PyHeliosOutputWrapper::finished,
                  &PyHeliosOutputWrapper::finished)
    .add_property("outpath",
                  &PyHeliosOutputWrapper::outpath,
                  &PyHeliosOutputWrapper::outpath)
    .add_property("filepath",
                  &PyHeliosOutputWrapper::outpath,
                  &PyHeliosOutputWrapper::outpath)
    .add_property("outpaths",
                  &PyHeliosOutputWrapper::outpaths,
                  &PyHeliosOutputWrapper::outpaths)
    .add_property("filepaths",
                  &PyHeliosOutputWrapper::outpaths,
                  &PyHeliosOutputWrapper::outpaths);

  // Register PySimulationCycleCallback
  class_<PySimulationCycleCallback>("SimulationCycleCallback",
                                    init<PyObject*>())
