...
// ******************* //
void
PySceneWrapper::translate(double const x, double const y, double const z)
{
...
// ********************** //
DynScene&
PySceneWrapper::_asDynScene()
{
  try {
    return dynamic_cast<DynScene&>(scene);
  } catch (std::exception& ex) {
    throw PyHeliosException("Failed to obtain scene as dynamic scene");
  }
}
