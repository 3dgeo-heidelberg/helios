...
fluxionum::IndexedDesignMatrix<IndexType, VarType>::toLinearTimeDiffDesignMatrix(
    double const ta,
    double const tb,
...
fluxionum::IndexedDesignMatrix<IndexType, VarType>::toLinearTimeDiffDesignMatrixPointer(
    double const ta,
    double const tb,
    fluxionum::DiffDesignMatrixType diffType
) const {
