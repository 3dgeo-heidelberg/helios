...
public:
     ...
     */
    ParametricClosestLesserSampleFunction<A, B> &
    operator=(ParametricClosestLesserSampleFunction<A, B> const &pclsf){
        this->~ParametricClosestLesserSampleFunction<A, B>();
        new(this) ParametricClosestLesserSampleFunction<A, B>(
            pclsf.t, pclsf.y, pclsf.i
        );
        return *this;
    }
