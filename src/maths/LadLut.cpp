...
double
LadLut::computeSigma(double padBVTotal, double x, double y, double z)
{
...
double
LadLut::interpolate(double x, double y, double z)
{
  ...
  findEnvelopmentDirections(
    wx, wy, wz, uIdx, ux, uy, uz, vIdx, vx, vy, vz, a, b);
...
// *********************** //
void
LadLut::transformToLadLutDomain(double a,
                                double b,
                                double c,
                                double& x,
                                double& y,
...
inline void
LadLut::fastTransformToLadLutDomain(double a,
                                    double b,
                                    double c,
                                    double& x,
                                    double& y,
...
void
LadLut::findEnvelopmentDirections(double wx,
                                  double wy,
                                  double wz,
                                  size_t& uIdx,
                                  double& ux,
