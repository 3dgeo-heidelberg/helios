 ...
 */
std::vector<double> Triangle::getRayIntersection(
    const glm::dvec3 &rayOrigin,
    const glm::dvec3 &rayDir
){
...
double Triangle::calcArea3D() {
    glm::dvec3 ab = glm::dvec3(
        verts[1].getX() - verts[0].getX(),
        verts[1].getY() - verts[0].getY(),
        verts[1].getZ() - verts[0].getZ()
    );
    glm::dvec3 ac = glm::dvec3(
        verts[2].getX() - verts[0].getX(),
