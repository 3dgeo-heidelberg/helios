...
public:
	 ...
	 */
	virtual double getIncidenceAngle_rad(
	 ...
	 */
	virtual std::vector<double> getRayIntersection(
	    const glm::dvec3& rayOrigin, const glm::dvec3& rayDir) = 0;
	/**
	 ...
	 */
    virtual double getRayIntersectionDistance(
        const glm::dvec3& rayOrigin, const glm::dvec3& rayDir) = 0;
    /**
