...
double
Voxel::getIncidenceAngle_rad(const glm::dvec3& rayOrigin,
...
std::vector<double>
Voxel::getRayIntersection(const glm::dvec3& rayOrigin, const glm::dvec3& rayDir)
{
  return bbox->getRayIntersection(rayOrigin, rayDir);
}
double
Voxel::getRayIntersectionDistance(const glm::dvec3& rayOrigin,
                                  const glm::dvec3& rayDir)
{
