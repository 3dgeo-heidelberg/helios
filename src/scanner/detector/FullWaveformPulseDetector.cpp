...
FullWaveformPulseDetector::clone()
{
...
void
FullWaveformPulseDetector::_clone(std::shared_ptr<AbstractDetector> ad)
{
...
// *********************** //
void
FullWaveformPulseDetector::applySettings(shared_ptr<ScannerSettings>& settings)
{
