...
public:
   ...
   */
  OscillatingMirrorBeamDeflector(double scanAngleMax_rad,
   ...
   */
  std::string getOpticsType() const override { return "OSCILLATING_MIRROR"; }
   ...
   * @return
   */
  void accelerateBeamAngle(double const p,
                           double const pa,
                           double const norm,
                           double const sign);
  /**
   ...
   *  or decreasing (negative, -1)
   */
  void decelerateBeamAngle(double const p,
                           double const pb,
                           double const norm,
                           double const sign);
