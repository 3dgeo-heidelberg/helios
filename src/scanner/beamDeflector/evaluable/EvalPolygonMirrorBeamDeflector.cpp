...
void EvalPolygonMirrorBeamDeflector::_clone(
    std::shared_ptr<AbstractBeamDeflector> abd
){
    PolygonMirrorBeamDeflector::_clone(abd);
    EvalPolygonMirrorBeamDeflector *epmbd = (EvalPolygonMirrorBeamDeflector *)
        abd.get();
...
// ***  M E T H O D S  *** //
// *********************** //
void EvalPolygonMirrorBeamDeflector::applySettings(
