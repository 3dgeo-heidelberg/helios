...
// ********************************* //
void SimpleKDTreeGeometricStrategy::GEOM_defineSplit(
    KDTreeNode *node,
    KDTreeNode *parent,
...
void SimpleKDTreeGeometricStrategy::GEOM_computeNodeBoundaries(
    KDTreeNode *node,
    KDTreeNode *parent,
    bool const left,
...
void SimpleKDTreeGeometricStrategy::GEOM_populateSplits(
    vector<Primitive *> const &primitives,
    int const splitAxis,
...
void SimpleKDTreeGeometricStrategy::GEOM_buildChildrenNodes(
    KDTreeNode *node,
    KDTreeNode *parent,
    vector<Primitive *> const &primitives,
    int const depth,
    ...
    if(kdtf.checkNodeMustSplit(primitives, leftPrimitives, rightPrimitives)){
        ...
        if(!leftPrimitives.empty()){ // Compute left child node
            kdtf.setChild(node->left, kdtf._buildRecursive(
