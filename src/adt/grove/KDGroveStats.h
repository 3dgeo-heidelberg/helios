...
public:
  ...
  KDGroveStats()
    ...
    , meanBuildingTime(0)
    , stdevBuildingTime(0)
    , totalTreePrimitives(0)
    , minTreePrimitives(0)
    , maxTreePrimitives(0)
    , meanTreePrimitives(0)
    , stdevTreePrimitives(0)
  ...
  string toString() const
  {
    ...
    ss << "KDGrove stats:\n"
       ...
       << "\t\tBuilding time: (" << minBuildingTime << ", " << maxBuildingTime
       << ", " << totalBuildingTime << ", " << meanBuildingTime << ", "
       << stdevBuildingTime << ")\n"
       << "\t\tTree primitives: (" << minTreePrimitives << ", "
       << maxTreePrimitives << ", " << totalTreePrimitives << ", "
       << meanTreePrimitives << ", " << stdevTreePrimitives << ")\n"
       << "\t\tMax primitives in leaf: (" << minMaxPrimsInLeaf << ", "
       << maxMaxPrimsInLeaf << ", " << totalMaxPrimsInLeaf << ", "
       << meanMaxPrimsInLeaf << ", " << stdevMaxPrimsInLeaf << ")\n"
       << "\t\tMin primitives in leaf: (" << minMinPrimsInLeaf << ", "
       << maxMinPrimsInLeaf << ", " << totalMinPrimsInLeaf << ", "
       << meanMinPrimsInLeaf << ", " << stdevMinPrimsInLeaf << ")\n"
       << "\t\tMaximum depth: (" << minMaxDepth << ", " << maxMaxDepth << ", "
       << totalMaxDepth << ", " << meanMaxDepth << ", " << stdevMaxDepth
       << ")\n"
       << "\t\tAxis-aligned surface area: (" << minSurfaceArea << ", "
       << maxSurfaceArea << ", " << totalSurfaceArea << ", " << meanSurfaceArea
       << ", " << stdevSurfaceArea << ")\n"
       << "\t\tNumber of interior nodes: (" << minNumInterior << ", "
       << maxNumInterior << ", " << totalNumInterior << ", " << meanNumInterior
       << ", " << stdevNumInterior << ")\n"
       << "\t\tNumber of leaf nodes: (" << minNumLeaves << ", " << maxNumLeaves
       << ", " << totalNumLeaves << ", " << meanNumLeaves << ", "
       << stdevNumLeaves << ")\n"
       << "\t\tTree cost: (" << minCost << ", " << maxCost << ", " << totalCost
       << ", " << meanCost << ", " << stdevCost << ")\n";
    return ss.str();
  }
