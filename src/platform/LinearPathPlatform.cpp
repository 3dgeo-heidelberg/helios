...
void
LinearPathPlatform::_clone(std::shared_ptr<Platform> p)
{
...
// *********************** //
void
LinearPathPlatform::doSimStep(int simFrequency_hz)
{
...
void
LinearPathPlatform::setDestination(glm::dvec3 dest)
{
