...
void
BaseMeasurementWriter<WriteArgs...>::configure(std::string const& parent,
...
template<typename... WriteArgs>
WriterType
BaseMeasurementWriter<WriteArgs...>::chooseWriterType() const
{
  if (isLas10())
    return las10Type;
  else if (isLasOutput())
...
template<typename... WriteArgs>
void
BaseMeasurementWriter<WriteArgs...>::finish()
{
  ...
  typename std::unordered_map<
    std::string,
    std::shared_ptr<SyncFileWriter<WriteArgs...>>>::iterator it;
...
template<typename... WriteArgs>
void
BaseMeasurementWriter<WriteArgs...>::setOutputFilePath(
