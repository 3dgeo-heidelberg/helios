...
NormalNoiseSource<RealType>::configureNormalNoise(
    RealType mean,
    RealType stdev
){
...
// ************************** //
template<typename RealType>
std::ostream& operator << (std::ostream &out,NormalNoiseSource<RealType> &ns){
