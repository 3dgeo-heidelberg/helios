...
TEST_CASE("Randomness generation test") {
    ...
    SECTION("Uniform real distribution with long seed") {
        double expectedURD1[] = {0.417022, 0.997185, 0.720324, 0.932557, 0.000114};
    ...
    SECTION("Uniform real distribution with double seed") {
        double expectedURD2[] = {-0.12801, -0.629836, -0.948148, 0.863082, 0.099325};
    ...
    SECTION("Uniform real distribution with parsed string timestamp seed") {
        double expectedURD6[] = {-0.451698, 19.3035, -68.2896, -78.9788, -91.9135};
    ...
    SECTION("DEFAULT_RG behavior") {
        ...
        for(size_t i = 0 ; i < 5 ; i++){
            ...
            REQUIRE(drgCopy1.uniformRealDistributionNext() != drgCopy2.uniformRealDistributionNext());
            REQUIRE(drgCopy1.normalDistributionNext() != drgCopy2.normalDistributionNext());
        }
        ...
        for(size_t i = 0 ; i < 5 ; i++){
            REQUIRE(drgCopy3.uniformRealDistributionNext() == drgCopy4.uniformRealDistributionNext());
            REQUIRE(drgCopy3.normalDistributionNext() == drgCopy4.normalDistributionNext());
        }
    }
}