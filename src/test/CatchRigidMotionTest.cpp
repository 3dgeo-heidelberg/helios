...
TEST_CASE("Rigid motion test") {
    ...
    SECTION("RigidMotion: Pure R2 Motions") {
        ...
        SECTION("Identity R2") {
            ...
            REQUIRE(rigidmotion::RigidMotion::SuperType::R2_BASE == f.findSuperType());
        ...
        SECTION("Reflection R2") {
            ...
            REQUIRE(rigidmotion::RigidMotion::SuperType::R2_REFLECTION == f.findSuperType());
            REQUIRE(f.hasFixedPoints());
        ...
        SECTION("Glide Reflection R2") {
            ...
            REQUIRE(rigidmotion::RigidMotion::SuperType::R2_REFLECTION == f.findSuperType());
            REQUIRE(!f.hasFixedPoints());
            REQUIRE(rigidmotion::RigidMotion::Type::GLIDE_REFLECTION_R2 == f.findType());
            REQUIRE(f.findInvariantDimensionality() == 1);
            size_t dim;
        ...
        SECTION("Rotation R2") {
            ...
            arma::mat Z = abs(Y-EY);
            REQUIRE(!arma::any(arma::vectorise(Z) > eps));
            REQUIRE(rigidmotion::RigidMotion::SuperType::R2_ROTATION == f.findSuperType());
            REQUIRE(f.hasFixedPoints());
    ...
    SECTION("RigidMotion: Pure R3 Motions") {
        ...
        SECTION("Identity R3") {
            ...
            REQUIRE(!arma::any(arma::vectorise(Z) > eps));
            REQUIRE(rigidmotion::RigidMotion::SuperType::R3_BASE == f.findSuperType());
            REQUIRE(f.hasFixedPoints());
        ...
        SECTION("Reflection R3") {
            ...
            Z = abs(Y-R3X);
            REQUIRE(!arma::any(arma::vectorise(Z) > eps));
            REQUIRE(rigidmotion::RigidMotion::SuperType::R3_REFLECTION == f.findSuperType());
            REQUIRE(f.hasFixedPoints());
        ...
        SECTION("Glide Reflection R3") {
            ...
            REQUIRE(rigidmotion::RigidMotion::SuperType::R3_REFLECTION == f.findSuperType());
            REQUIRE(!f.hasFixedPoints());
            REQUIRE(rigidmotion::RigidMotion::Type::GLIDE_REFLECTION_R3 == f.findType());
            REQUIRE(f.findInvariantDimensionality() == 2);
            size_t dim;
            arma::mat L = rme.computeAssociatedInvariant(f, dim);
            if(L(0, 0) < 0) L = -L;
        ...
        SECTION("Rotation R3") {
            ...
            arma::mat Z = abs(Y-EY);
            REQUIRE(!arma::any(arma::vectorise(Z) > eps));
            REQUIRE(rigidmotion::RigidMotion::SuperType::R3_ROTATION == f.findSuperType());
            REQUIRE(f.hasFixedPoints());
    ...
    SECTION("RigidMotion: Helios Dynamic Motions") {
        ...
        auto validate_dyn_motion = [&](const DynMotion& dm, const rigidmotion::RigidMotion& rm, DynMovingObject dynObj) {
        ...
        SECTION("Translation R3") {
            DynMovingObject dynObj = dmo;
            rigidmotion::RigidMotion tr = rm3f.makeTranslation(arma::colvec("-0.1;0.1;0"));
        ...
        SECTION("Rotational Symmetry R3") {
            DynMovingObject dynObj = dmo;
            arma::colvec O = dmo.getCentroid();
            rigidmotion::RigidMotion rs = rme.compose(
                rm3f.makeTranslation(O),
                rme.compose(
