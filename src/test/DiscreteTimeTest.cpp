...
TEST_CASE("Discrete time test")
{
  SECTION("Discrete time test with f=500, periodScale=1.0")
  {
    ...
    {
      auto [cont, disc] =
        GENERATE(std::make_tuple(0.5, 250), std::make_tuple(1.5, 750));
  ...
  SECTION("Discrete time test with f=500, periodScale=2.0")
  {
    ...
    {
      auto [cont, disc] = GENERATE(std::make_tuple(0.0, 0),
                                   std::make_tuple(0.2, 100),
                                   std::make_tuple(0.5, 250),
                                   std::make_tuple(1.5, 750),
                                   std::make_tuple(2.0, 0),
                                   std::make_tuple(2.2, 100),
                                   std::make_tuple(2.5, 250),
                                   std::make_tuple(3.5, 750));
    ...
    {
      auto [disc, cont] = GENERATE(std::make_tuple(0, 0.0),
                                   std::make_tuple(100, 0.2),
                                   std::make_tuple(250, 0.5),
                                   std::make_tuple(500, 1.0),
                                   std::make_tuple(750, 1.5),
                                   std::make_tuple(1000, 0.0),
                                   std::make_tuple(1250, 0.5),
                                   std::make_tuple(1500, 1.0),
                                   std::make_tuple(1750, 1.5));
  ...
  SECTION("Discrete time test with f=500, periodScale=0.5")
  {
    ...
    SECTION("toCyclicContinuous")
    {
      auto [disc, cont] = GENERATE(std::make_tuple(250, 0.5),
                                   std::make_tuple(750, 0.5),
                                   std::make_tuple(1750, 0.5));
    ...
    SECTION("toPeriodicContinuous")
    {
      auto [disc, cont] = GENERATE(std::make_tuple(0, 0.0),
                                   std::make_tuple(100, 0.2),
                                   std::make_tuple(250, 0.0),
                                   std::make_tuple(500, 0.0),
                                   std::make_tuple(750, 0.0),
                                   std::make_tuple(1000, 0.0),
                                   std::make_tuple(1250, 0.0),
                                   std::make_tuple(1350, 0.2),
                                   std::make_tuple(1500, 0.0),
                                   std::make_tuple(1750, 0.0));
  ...
  SECTION("Discrete time test with f=1000000, periodScale=1.0")
  {
    ...
    SECTION("toDiscrete")
    {
      auto [cont, disc] = GENERATE(std::make_tuple(0.00000000001, 0),
                                   std::make_tuple(0.000001, 1),
                                   std::make_tuple(0.999999999999, 999999),
                                   std::make_tuple(3.00000000001, 3000000),
                                   std::make_tuple(2.000001, 2000001),
                                   std::make_tuple(4.999999999999, 4999999));
    ...
    SECTION("toCyclicDiscrete and toPeriodicDiscrete")
    {
      auto [cont, disc] = GENERATE(std::make_tuple(3.00000000001, 0),
                                   std::make_tuple(2.000001, 1),
                                   std::make_tuple(4.999999999999, 999999));
    ...
    {
      auto [disc, cont] =
        GENERATE(std::make_tuple(0, 0.0), std::make_tuple(1, 0.000001));
    ...
    {
      auto [disc, subtrahend, cont] =
        GENERATE(std::make_tuple(999999, 0.999999, 0.0000001),
                 std::make_tuple(2000001, 2.000001, 0.0000001),
                 std::make_tuple(4999999, 4.999999, 0.0000001));
    ...
    SECTION("toCyclicContinuous and toPeriodicContinuous with many digits and "
            "differences")
    {
      auto [disc, subtrahend, cont] =
        GENERATE(std::make_tuple(2000001, 0.000001, 0.0000001),
                 std::make_tuple(4999999, 0.999999, 0.0000001));
    ...
    SECTION("Inverse tests with toCyclicDiscrete/toContinuous and "
            "toPeriodicDiscrete/toContinuous")
    {
    ...
    SECTION("Inverse tests with toCyclicContinuous/toDiscrete and "
            "toPeriodicContinuous/toDiscrete")
    {
