...
public:
  ...
  bool validate(std::shared_ptr<IExprTreeNode<InputType, OutputType>> f,
  ...
  bool validatePowIPow(std::shared_ptr<UnivarExprTreeNode<NumericType>> f,
...
// ******************* //
bool
ExprTreeTest::testUnivarExprTree()
{
  // Prepare tests
  ...
  y = std::vector<double>({ 122.00000000,
                            18.13960000,
                            14.83840000,
                            5.41000000,
                            2.79560000,
                            ...
                            5.57960000,
                            82.00000000 });
  if (!validate<double, double>(node, t, y))
    return false;

  // Test case 2: exp(t)+3*cos(1+2*t)
  node = uetsf.makeShared("exp(t)+3*cos(1+2*t)");
  y = std::vector<double>({ 2.96615925e+00,
                            1.65614048e+00,
                            -7.41224555e-01,
                            1.41994435e+00,
                            3.55947658e+00,
  ...
  y = std::vector<double>({ -1.95213944,
                            0.23146637,
                            0.36515653,
                            0.88081854,
                            1.12273406,
  ...
  y = std::vector<double>({ -50.00000000,
                            -15.70000000,
                            -13.60000000,
                            -5.50000000,
                            -1.70000000,
  ...
  y = std::vector<double>({ -10.00000000,
                            -3.14000000,
                            -2.72000000,
                            -1.10000000,
                            -0.34000000,
  ...
  y = std::vector<double>({ -3.72100000e+03,
                            -1.01537776e+02,
                            -6.47393920e+01,
                            -4.89400000e+00,
                            -1.49041600e+00,
  ...
  y = std::vector<double>({ 3.60000000e+03,
                            NAN,
                            NAN,
                            NAN,
                            NAN,
  ...
  y = std::vector<double>({ -0.83907153,
                            -0.99999873,
                            -0.91243836,
                            0.45359612,
                            0.94275467,
  ...
  y = std::vector<double>({ 0.62298863,
                            0.28904527,
                            -0.82692784,
                            -0.87643472,
                            0.02598973,
  ...
  y = std::vector<double>({ 70.00000000,
                            21.98000000,
                            19.04000000,
                            7.70000000,
                            2.38000000,
  ...
  y = std::vector<double>({ 4.95991487e-01,
                            4.52163439e-01,
                            4.35614983e-01,
                            8.83763993e-02,
                            -4.06060606e+00,
  ...
  y = std::vector<double>({ 11.14208743,
                            1.39014251,
                            1.29353943,
                            1.05582653,
                            1.00725079,
  ...
  y = std::vector<double>({ 1.67046498,
                            1.87911199,
                            1.92310505,
                            2.30861139,
                            2.81385415,
  ...
  if (!validate<double, double>(node, node2, t))
    return false;

  // Test case 21: t+(1)
  node = uetsf.makeShared("t+(1)");
  y = std::vector<double>({ -9.00000000,
                            -2.14000000,
                            -1.72000000,
                            -0.10000000,
                            0.66000000,
  ...
  y = std::vector<double>({ -11.00000000,
                            -4.14000000,
                            -3.72000000,
                            -2.10000000,
                            -1.34000000,
  ...
  if (!validate<double, double>(node, t, t))
    return false;
  ...
  y = std::vector<double>({ -0.53854944,
                            -0.47512005,
                            -0.46205665,
                            -0.34229969,
                            -0.11111695,
  ...
  y = std::vector<double>({ -1.18798772,
                            -1.24225167,
                            -1.25294846,
                            -1.34443033,
                            -1.49570776,
  ...
  y = std::vector<double>({ 0.99668652,
                            0.96811118,
                            0.95827973,
                            0.81159657,
                            0.42263966,
  ...
  y = std::vector<double>({ 1.3200000e+00,
                            6.6817944e-02,
                            4.7758848e-02,
                            7.1610000e-03,
                            1.0661040e-03,
  ...
  node = uetsf.makeShared(
    "(1000+((1-(1+sin(1/2+3*pi/3*t))*(2+t))*abs(t)^(2-1/2)))^(3/2)");
  y = std::vector<double>({ 52714.18945957,
                            32171.06013344,
                            31838.59857288,
                            31637.35056204,
                            31624.96953355,
  ...
  y = std::vector<double>({ 0.91282919,
                            0.97082196,
                            0.90930816,
                            -0.9976885,
                            -0.01534952,
  ...
  node = uetsf.makeShared(
    "cos(3*t+atan2(t,1)-5*atan2(1/1+1-1,t/t*t)^(2*sqrt(abs(t))))");
  y = std::vector<double>({ -0.45058035,
                            -0.83062706,
                            0.94696144,
                            -0.49875059,
                            0.79075789,
  ...
  if (!validate<double, double>(node, t, y))
    return false;
  if (!validatePowIPow<double>(node, 0, 2))
    return false;
  ...
  if (!validate<double, double>(node, t, y))
    return false;
  if (!validatePowIPow<double>(node, 1, 0))
    return false;
  ...
  if (!validate<double, double>(node, t, y))
    return false;
  if (!validatePowIPow<double>(node, 1, 1))
    return false;
...
bool
ExprTreeTest::testRegUnivarExprTree()
{
  // Prepare tests
  ...
  node = ruetsf.makeShared("(ER0+((ER1-(ER1+sin(ER1/ER2+ER3*pi/ER3*t))*(ER2+t))"
  ...
  node =
    ruetsf.makeShared("cos(ER0*t+atan2(t,ER1)-ER2*atan2(ER1/ER1+ER1-ER1,t/t*t)^"
                      "(ER3*sqrt(abs(t))))");
  y = std::vector<double>({ -0.45058035,
                            -0.83062706,
                            0.94696144,
