...
def get_paths(survey_file):
    ...
    try:
        ...
        scene_file, scanner_file, platform_file = handle_relative_path(
            PYH_DIR, scene_file, scanner_file, platform_file
        )
    except KeyError as e:
        print(
            "ERROR: Missing 'platform', 'scanner' or 'scene' key in <survey> tag.\n"
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "demo" / "als_hd_demo_tiff.xml"),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "demo"
                / "light_als_toyblocks_multiscanner.xml"
            ),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "demo"
                / "als_hd_height_above_ground_stripid.xml"
            ),
            id="als_hd_stripid.xml",
        ),
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "demo" / "mls_wheat_demo.xml"),
            id="mls_wheat_demo.xml",
        ),
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "demo" / "tls_arbaro_demo.xml"),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "demo"
                / "tls_arbaro_demo_angular_resolution.xml"
            ),
            id="tls_arbaro_angular_resolution.xml",
        ),
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "demo" / "tls_livox.xml"),
            id="tls_livox.xml",
        ),
        pytest.param(
            (
        ...
        pytest.param(
            (Path(WORKING_DIR) / "data" / "dev" / "moving_tls_toyblocks.xml"),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "toyblocks"
                / "uls_toyblocks_stop_and_turn.xml"
            ),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "voxels"
                / "als_detailedVoxels_mode_comparison.xml"
            ),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "voxels"
                / "tls_sphere_xyzloader_normals.xml"
            ),
        ...
        pytest.param(
            (
                ...
                / "surveys"
                / "voxels"
                / "uls_detailedVoxels_mode_comparison.xml"
            ),
            id="uls_detailedVoxels_mode_comparison.xml",
        ),
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "dyn" / "tls_dyn_cube.xml"),
            id="tls_dyn_cube.xml",
        ),
        pytest.param(
            (Path(WORKING_DIR) / "data" / "surveys" / "dyn" / "mls_urban_dyn.xml"),
