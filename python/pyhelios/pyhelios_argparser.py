...
parser.add_argument(
    "survey_file",
    help="Absolute or relative path to .XML survey file to be used for simulation.",
)

parser.add_argument(
    "--test",
    dest="test_is_desired",
    action="store_const",
    const=True,
...
parser.add_argument(
    ...
    dest="platform_noise_disabled_flag",
    action="store_const",
    const=True,
    default=False,
