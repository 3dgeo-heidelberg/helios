...
from pydantic import Field, PositiveFloat, NonNegativeFloat, NonNegativeInt, PositiveInt, validate_call
...
class ScenePart(Model, cpp_class=_helios.ScenePart):
    ...
    force_on_ground: PositiveInt = 1  #  temporary placeholder it would be as below
